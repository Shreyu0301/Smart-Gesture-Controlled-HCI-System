"""
Hand Tracking Module - MediaPipe wrapper for hand landmark detection
...
class HandTracker:
    def __init__(self):
        ...
        self.cooldown_frames = 3  # Reduced to 3 for very fast detection
        self.smooth_cooldown_frames = 1  # Reduced to 1 for instant response
